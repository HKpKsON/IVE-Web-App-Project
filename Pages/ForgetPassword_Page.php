...
<div class="container">
	<form class="form-register" action="?action=findmypassword" method="POST">
		...
		<div class="alert alert-danger alert-dismissible">
			...
			<strong>Opps!</strong> Please proof that you are not a robot!
		</div>
		<?php } ?>
		<?php
			if(isset($_GET['error']) && $_GET['error'] == 'nosuchmember'){
		?>
		<div class="alert alert-danger alert-dismissible">
			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<strong>Opps!</strong> There is no such user!
		</div>
		<?php } ?>
		<?php
		...
		<div class="alert alert-danger alert-dismissible">
			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<strong>Opps!</strong> You forgot to fill up the form!
		</div>
		<?php } ?>
		<div class="col-md-6">
